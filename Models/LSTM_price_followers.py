...
followers_data_numeric = pd.to_numeric(tweets['Followers'])
...
followerDataScaler = DataScaler(dataset=followers_data_numeric, interval=interval, name='Sentiment')
followerDataScaler.createTrainingData()
followerDataScaler.createTestData()

model = LSTM(
    inputs=[priceDataScaler, followerDataScaler], 
    scaler=priceDataScaler.scaler, 
    name='price_followers_{}_{}_{}'.format(batch_train, batch_predict, epoch))

"""

RMSE: 0.01120924479874673
RME: 0.010715841966131031
Batch Size Train: 64
Batch Size Predict: 1
"""
